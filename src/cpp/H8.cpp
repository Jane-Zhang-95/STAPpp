	...
	for (unsigned int i = 0; i < 2; i++) {
		for (unsigned int j = 0; j < 2; j++) {
            for (unsigned int k = 0; k < 2; k++) {
                ...
                // double J_inv_11 = (J[1][1]*J[2][2]-J[1][2]*J[2][1]) / det_J;
                // double J_inv_21 = - (J[1][0]*J[2][2]-J[1][2]*J[2][0]) / det_J;
                // double J_inv_31 = (J[1][0]*J[2][1]-J[2][0]*J[1][1]) / det_J;
                // double J_inv_12 = - (J[0][1]*J[2][2]-J[2][1]*J[0][2]) / det_J;
                // double J_inv_22 = (J[0][0]*J[2][2]-J[0][2]*J[2][0]) / det_J;
                // double J_inv_32 = - (J[0][0]*J[2][1]-J[2][0]*J[0][1]) / det_J;
                // double J_inv_13 = (J[0][1]*J[1][2]-J[1][1]*J[0][2]) / det_J;
                // double J_inv_23 = - (J[0][0]*J[1][2]-J[1][0]*J[0][2]) / det_J;
                // double J_inv_33 = (J[0][0]*J[1][1]-J[1][0]*J[0][1]) / det_J;
